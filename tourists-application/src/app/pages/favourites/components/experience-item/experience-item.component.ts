...
import * as store2 from './../../../dashboard/store';
...
export class ExperienceItemComponent implements OnInit {
  ...
  async markFavourite() {
    this.storage.setExperienceFavourite(!this.experience.favourite, this.experience.id);
    this.st2.dispatch(new store2.SetExperienceFavourite(!this.experience.favourite, this.experience.id));
  }
