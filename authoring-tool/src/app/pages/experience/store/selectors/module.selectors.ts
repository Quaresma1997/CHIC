...
/*export const getSelectedModule = createSelector(getModulesEntities, navigation.getRouterState,
    (entities, router): core.ModuleModel => {
...
export const getFirstModuleId = () => createSelector(getAllModules,
    (entities): string => {
        // if router.state exists && ...
